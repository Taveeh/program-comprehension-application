...
public class FoodController {
    ...
    @RequestMapping(value = "/food/valid", method = RequestMethod.GET)
    FoodsDto getNotExpiredFood() {
        logger.trace("getNotExpiredFood - method entered");
        List<Food> food = foodService.getNotExpiredFood();
        FoodsDto foodsDto = new FoodsDto(foodConverter.convertModelsToDTOs(food));
        logger.trace("getNotExpiredFood: " + food);
        return foodsDto;
    }
}
